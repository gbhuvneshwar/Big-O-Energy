...
assert kidsWithCandies([1,2,3,4,5], 5) == [True, True, True, True, True]
assert kidsWithCandies([1,2,3,4,5], 0) == [False, False, False, False, False]
assert kidsWithCandies([1,2,3,4,5], 1) == [False, False, False, False, False]